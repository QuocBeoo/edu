      ...
      <div className="flex items-center justify-between py-4 px-6 2xl:px-2 mx-auto max-w-[1320px] min-h-[75px]">
        ...
        <div className="box-search relative min-w-[200px]">
          <input
            ...
            placeholder="Search..."
          />
          <div className="search absolute m-auto top-0 right-[-180px] 2xl:right-[-250px] left-0 bottom-0 w-[40px] h-[40px] border border-[#dddedf] rounded-full cursor-pointer bg-white dark:bg-transparent"></div>
        </div>
      </div>
    </header>
  );
